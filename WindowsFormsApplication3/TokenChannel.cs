    ...
    public static List<Candle> ConvertToJason(string jSon, string stockName = "", bool heikenAshi = false)
    {
        ...
        foreach (string jCandle in listOfCandles)
        {
            ...
            latestCandle = new Candle()
            {
                ...
                AllIndicators = new Model.AllTechnicals { SMA20 = avg20.Average, SMA50 = avg20.Average, SMA200 = avg200.Average, SuperTrend = new SuperTrend { SuperTrendValue = sObj.SuperTrend, Trend = (int)sObj.Trend }, BollingerBand = avg20.BollingerBand },
                Stock = stockName
